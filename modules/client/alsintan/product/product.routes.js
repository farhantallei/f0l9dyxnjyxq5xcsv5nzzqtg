...
const productRoutes = (route) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    route.get('/:productId/review', {
        schema: product_schemas_1.GetProductReviewsSchema,
        handler: product_handlers_1.GetProductReviewsHandler,
    });
    route.post('/:productId/daily', {
        schema: product_schemas_1.RentDailyProductSchema,
        handler: product_handlers_1.RentDailyProductHandler,
    });
    route.post('/:productId/plotly', {
        schema: product_schemas_1.RentPlotlyProductSchema,
        handler: product_handlers_1.RentPlotlyProductHandler,
    });
});
